 ...
 */
require_once 'Zend/Service/Ebay/Shopping.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Zend_Service_Ebay_Shopping_Abstract
{
    /**
     * @var DOMElement
     */
    ...
    protected function _initXPath()
    {
        ...
        if (!isset($document->ebayFindingXPath)) {
            ...
            /*foreach (Zend_Service_Ebay_Trading::getXmlNamespaces() as $alias => $uri) {
                $xpath->registerNamespace($alias, $uri);
            }*/
            $document->ebayTradingXPath = $xpath;
        }
        $this->_xPath = $document->ebayTradingXPath;
    }
